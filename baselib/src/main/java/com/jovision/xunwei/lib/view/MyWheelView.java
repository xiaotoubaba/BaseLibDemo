...
public class MyWheelView extends ScrollView {
    ...
    public int getItemsSize(){
        return this.items.size() - (offset * 2);
    }
...
//            Log.d(TAG, "向上滚动");
    ...
    private void refreshItemView(int y) {
        ...
        for (int i = 0; i < childSize; i++) {
            ...
            if (position == i) {
                itemView.setTextColor(Color.parseColor("#2d2d32"));
            } else {
                itemView.setTextColor(Color.parseColor("#a9aabe"));
            }
        }
    }
...
//        }
        ...
        background = new Drawable() {
            ...
            public void draw(Canvas canvas) {
                canvas.drawLine(viewWidth * 1 / 6 + dip2px(10), obtainSelectedAreaBorder()[0], viewWidth * 5 / 6 - dip2px(10), obtainSelectedAreaBorder()[0], paint);
                canvas.drawLine(viewWidth * 1 / 6 + dip2px(10), obtainSelectedAreaBorder()[1], viewWidth * 5 / 6 - dip2px(10), obtainSelectedAreaBorder()[1], paint);
            }
...
//                WheelView.this.smoothScrollTo(0, p * itemHeight);
                MyWheelView.this.scrollTo(0, p * itemHeight);
            }
        });
    }

    public void setSmoothSeletion(int position){
        final int p = position;
        selectedIndex = p + offset;
        this.post(new Runnable() {
            @Override
