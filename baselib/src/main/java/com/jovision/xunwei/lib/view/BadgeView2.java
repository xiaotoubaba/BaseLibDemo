package com.jovision.xunwei.lib.view;
 ...
 * This class is intended to be instantiated at runtime rather than included in XML layouts.<br/>
 * github:<a href="https://github.com/jgilfelt/android-viewbadger">https://github.com/jgilfelt/android-viewbadger</a><br/>
 * 
 * @author Jeff Gilfelt
 */
public class BadgeView2 extends TextView {
     ...
     */
	public BadgeView2(Context context, View target) {
     ...
     */
	public BadgeView2(Context context, TabWidget target, int index) {
		this(context, null, android.R.attr.textViewStyle, target, index);
	}

	public BadgeView2(Context context, AttributeSet attrs, int defStyle) {
		this(context, attrs, defStyle, null, 0);
	}

	public BadgeView2(Context context, AttributeSet attrs, int defStyle, View target, int tabIndex) {
