...
/**
  ...
  * 作者思路是画圆用渲染器位图填充，而不是把Bitmap重绘切割成一个圆形图片。<br>
  * 
  * https://github.com/hdodenhof/CircleImageView<br>
  * http://blog.csdn.net/zhoubin1992/article/details/47258639<br/>
  */
public class CircleImageView extends ImageView {
    ...
    private void setup() {
        ...
        updateShaderMatrix(mBorderRect, mDrawableRect);
    ...
    */
    private void updateShaderMatrix(RectF mBorderRect, RectF mDrawableRect) {
        float scale;
        float dx = 0;
        float dy = 0;
